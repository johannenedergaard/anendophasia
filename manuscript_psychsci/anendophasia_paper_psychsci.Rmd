...
abstract: |
  It is commonly assumed that inner speech – the experience of thought as occurring in a natural language – is both frequent and universal. Recent evidence, however, suggests that the experience of inner speech varies between people, ranging from constant to non-existent. We propose a name for a lack of the experience of inner speech – anendophasia – and report four studies examining some of its behavioral consequences. We found that people who report low levels of inner speech (N = 46) have lower performance on a verbal working memory task and have more difficulty performing rhyme judgments compared with people who report high levels of inner speech (N = 47). Task switching performance, previously linked to endogenous verbal cueing, and categorical effects on perceptual judgments were unaffected by differences in inner speech. 
...
Everyone, it is often said, has an inner voice, and most of our waking hours are claimed to be filled with inner speech: ‘Daily, human beings are engaged in a form of inner dialogue, which enables them to [engage in] high-level cognition, including self-control, self-attention and self-regulation.’: [@chella2020cognitive, p. 287]; ‘We all hear a voice inside our brain, commonly called “inner voice”, “inner speech” or referred to as “verbal thoughts”’ (@perrone2014little, p. 22). Most people do report experiencing inner speech [@alderson2015inner; @morin2018self; @heavey2008phenomena] and because we often assume that our experiences mirror those of others, the majority experience comes to be viewed as universal [@lupyan2023hidden].
...
The experiment code and materials, data, and analysis scripts for the present study are publicly accessible at https://anonymous.4open.science/r/anendophasia-6F15. The present study was not preregistered. 
...
In addition to finding (or not finding) differences in task performance as a function of inner speech, it is often informative to see whether correlations between tasks and conditions show a different pattern in people with more vs. less inner speech [@keogh2021visual]. See Figure \@ref(fig:total-cor-contrast) for a visualization of how performance on the tasks correlated within the participant groups with more or less inner speech.
...
```{r total-cor-contrast, echo=FALSE,out.width='100%', fig.cap='Intertask correlations in the total sample of participants with more and less inner speech. Colored squares represent significant correlations at p < .01 which with the given sample size (N less inner speech = 45; N more inner speech = 47) is equivalent to a correlation coefficient of at least r = ±.38. The upper triangle represents intertask correlations for the participant group with more inner speech while the lower triangle represents intertask correlations for the participant group with less inner speech.'}
...
Measures within the tasks generally correlated, but we observed different correlations between the tasks for the two participant groups. For example, reaction times on rhyme judgments, task switching, and perceptual discrimination were more intercorrelated for the group with more inner speech than for the group with less inner speech, suggesting that these relied on similar mechanisms for the former group. Participants with less inner speech showed a positive correlation between accuracy on uncued switch trials and (position-indifferent) verbal working memory and rhyming accuracy, suggesting that these tasks relied on similar mechanisms for this participant group.
