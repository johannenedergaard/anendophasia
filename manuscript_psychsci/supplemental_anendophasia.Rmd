---
title: "Anendophasia (supplemental materials)"
...
library('kableExtra')
library('ggpubr')
setwd("/Users/au651723/Library/CloudStorage/OneDrive-AarhusUniversitet/OneDrive_Aarhus_universitet/Aarhus/Writings/Anendophasia/manuscript_psychsci")
...
In addition to finding (or not finding) differences in task performance as a function of inner speech, it is often informative to see whether correlations between tasks and conditions show a different pattern in people with more vs. less inner speech (Keogh, Wicken, & Pearson, 2021).
...
Figure 1 shows the task correlations for both inner speech groups: more inner speech in the upper triangle and less inner speech in the lower triangle.
...
knitr::include_graphics("../figures/survey_cor_contrast.png")
```
